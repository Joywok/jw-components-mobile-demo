...
class ToastExample extends React.Component {
  ...
  render() {
    return (
      <div>
        <br />
        <Button className="modal-alert" onClick={showToast}>text only</Button><br /><br />

        <Button className="modal-alert" onClick={showToastNoMask}>without mask</Button><br /><br />

        <Button className="modal-alert" onClick={() => Toast.info(customIcon(), 1)}>
          cumstom icon
        </Button><br /><br />

        <Button className="modal-alert" onClick={successToast}>success</Button><br /><br />

        <Button className="modal-alert" onClick={failToast}>fail</Button><br /><br />

        <Button className="modal-alert" onClick={offline}>network failure</Button><br /><br />

        <Button className="modal-alert" onClick={loadingToast}>loading</Button><br /><br />
      </div>
